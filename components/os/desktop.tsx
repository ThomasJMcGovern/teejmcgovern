  ...
  return (
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div
        ...
        className="absolute inset-0 bg-[radial-gradient(120%_90%_at_78%_8%,rgba(255,63,164,0.30),transparent_55%),radial-gradient(130%_100%_at_12%_98%,rgba(198,240,0,0.22),transparent_50%),linear-gradient(160deg,var(--color-desk-2),var(--color-desk-1)_45%,var(--color-desk-3))]"
      />
